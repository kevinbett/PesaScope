              ...
              return (
                <Fragment key={t.receipt + i}>
                  ...
                  >
                    ...
                    <td className="typ"><span className="m-time mono">{t.time.slice(0, 5)}</span><span className="catpill">{t.type}</span>{t.fuliza && t.cat !== 'Fuliza' ? <span className="catpill fz">Fuliza</span> : null}{(t.phone || t.code) && <span className="m-code mono">{t.phone || t.code}</span>}</td>
