...
export default function SearchResults({ q, result, cat, setCat, setQ, showTip, hideTip, onPick }) {
  const r = result
  const tiles = [
  ...
  return (
    <div className="search-results">
      ...
      <section className="panel">
        ...
        <TxnTable txns={r.rows} cat={cat} setCat={setCat} title={'Transactions matching ' + q} onPick={onPick} />
      </section>
    </div>
  )
}
